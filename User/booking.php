...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h4><span>Book Your Dreams</span></h4>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="info-table">
            <ul>
              <li>
                <h4>BOOK YOUR DREAM FLAT</h4><br><span>Welcome to our cozy and secure flat, where your safety is our top priority. Equipped with modern security systems and surveillance cameras, you can rest assured knowing that your well-being is safeguarded around the clock. Our flat offers peace of mind with sturdy locks, well-lit pathways, and a friendly neighborhood environment. Book your stay with us today and experience the comfort and security of our meticulously maintained property.We offer 24 hr security.</span></h4>
              </li>
